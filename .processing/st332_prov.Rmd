...
```{r }
ff_glimpse #to ensure data is coded correctly and data entry is robust
missing_plot 
missing_pattern #include this data in demographic tables
missing_pairs
missing_compare
...
```{r mice, echo=FALSE, output=FALSE}
...
## Modelling the sub-scale sport variable

```{r }
#descdist(cast$sport9) #because of NA values
``` 

## Limitations
* List-wise deletion of the observations in which bsport is missing introduces a bias in the inferences. There is a weak relationship between bsport and age, which means that list-wise deletion implies keeping the observations from younger people, on average. This may have consequences for our conclusions if age is associated with sport9.
